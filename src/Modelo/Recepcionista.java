...
public class Recepcionista {
    ...
    //de odontologos
    public String altaOdontologo(Odontologo odontologo) {
        if (odontologo.getMatricula() > 0) {
            this.odontologos.add(odontologo);
            return ("El odontólogo " + odontologo.getNombre() + " fue dado de alta correctamente.");
        } else {
            return ("ERROR: No se puede dar de alta al odontólogo " + odontologo.getNombre() + ". La matrícula " + odontologo.getMatricula() + " no es válida.");
        }
    }
